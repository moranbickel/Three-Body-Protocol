...
I built it while developing [ORCA](#about-orca), a closed-source legal-AI drafting system for Israeli civil litigation workflows. It's now the second of five methodology pieces I'm publishing. The first is [Russian Judge](https://github.com/moranbickel/russian-judge).
...
(STATUS_NOW has its own dedicated repo as the fifth methodology piece. This one names it; the other goes deep.)
...
This is the second of five methodology pieces from building [ORCA](#about-orca):
